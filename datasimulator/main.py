...
from .file_handling import write_submission_order_to_file, try_writing_to_file
...
def run_submission_order_generation(graph, data_path, node_name=None):
    ...
    if not path_exists:
        ...
        try_writing_to_file(file_path, write_submission_order_to_file(submission_order))
