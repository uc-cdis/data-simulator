import os
from datasimulator.file_handling import write_submission_order_to_file, try_writing_to_file
...
def test_write_to_file_or_log_error(tmpdir):
    ...
    succeeded = try_writing_to_file(test_path, write_submission_order_to_file(submission_order))
